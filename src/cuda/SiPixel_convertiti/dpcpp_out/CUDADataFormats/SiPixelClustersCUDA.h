...
public:
  ...
  public:
    ...
    */
    __dpct_inline__ uint32_t moduleStart(int i) const {
      return *(moduleStart_ + i);
    }
    /*
    DPCT1026:5: The call to __ldg was removed, because there is no
    correspoinding API in DPC++.
    */
    __dpct_inline__ uint32_t clusInModule(int i) const {
      return *(clusInModule_ + i);
    }
    /*
    ...
    */
    ...
    correspoinding API in DPC++.
    */
    __dpct_inline__ uint32_t clusModuleStart(int i) const {
      return *(clusModuleStart_ + i);
    }
